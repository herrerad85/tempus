...
object Constants {
    ...
    const val PLAYLIST_SONG_ORDER_BY_ORIGINAL = "PLAYLIST_SONG_ORDER_BY_ORIGINAL"
    const val PLAYLIST_SONG_ORDER_BY_TITLE_ASC = "PLAYLIST_SONG_ORDER_BY_TITLE_ASC"
    const val PLAYLIST_SONG_ORDER_BY_TITLE_DESC = "PLAYLIST_SONG_ORDER_BY_TITLE_DESC"
    const val PLAYLIST_SONG_ORDER_BY_ARTIST_ASC = "PLAYLIST_SONG_ORDER_BY_ARTIST_ASC"
    const val PLAYLIST_SONG_ORDER_BY_ARTIST_DESC = "PLAYLIST_SONG_ORDER_BY_ARTIST_DESC"
    const val PLAYLIST_SONG_ORDER_BY_ALBUM_ASC = "PLAYLIST_SONG_ORDER_BY_ALBUM_ASC"
    const val PLAYLIST_SONG_ORDER_BY_ALBUM_DESC = "PLAYLIST_SONG_ORDER_BY_ALBUM_DESC"
    const val PLAYLIST_SONG_ORDER_BY_RECENTLY_ADDED = "PLAYLIST_SONG_ORDER_BY_RECENTLY_ADDED"
    const val PLAYLIST_SONG_ORDER_BY_OLDEST_ADDED = "PLAYLIST_SONG_ORDER_BY_OLDEST_ADDED"
    ...
    const val CUSTOM_COMMAND_PLAY_NEXT = "com.eddyizm.tempus.PLAY_NEXT_FIXUP"
